...
export default function HeroA() {
  return (
    <section className="relative min-h-screen bg-[#0a0f1a] overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#7c3aed] rounded-full blur-[150px] opacity-20 animate-float" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative z-10 container mx-auto px-6 pt-32 pb-20">
        <div className="max-w-4xl">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#00d4ff]/30 bg-[#00d4ff]/10 mb-8">
            ...
            <span className="text-[#00d4ff] text-sm font-medium">工業 4.0 智能化解決方案</span>
          </div>
          ...
          <div className="flex flex-wrap gap-4 mb-16">
            <button className="px-8 py-4 bg-gradient-to-r from-[#00d4ff] to-[#7c3aed] text-white font-semibold rounded-lg hover:opacity-90 transition-all animate-pulse-glow">
              了解解決方案
            </button>
            <button className="px-8 py-4 border border-[#94a3b8]/30 text-white font-semibold rounded-lg hover:bg-white/5 transition-all">
              聯絡我們
            </button>
          </div>
      ...
      <div className="absolute right-10 top-1/2 -translate-y-1/2 hidden lg:block">
        <div className="relative w-80 h-80">
          ...
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 320 320">
            <circle cx="160" cy="160" r="80" fill="none" stroke="rgba(0,212,255,0.2)" strokeWidth="1" strokeDasharray="5,5" />
            <circle cx="160" cy="160" r="120" fill="none" stroke="rgba(124,58,237,0.2)" strokeWidth="1" strokeDasharray="5,5" />
          </svg>
        </div>
      </div>
    </section>
